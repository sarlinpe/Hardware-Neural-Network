...
architecture implementation of main_controller is
    ...
    signal feature_b_addr_idx : natural range 0 to (nb_features - 1);
    ...
    signal feature_a, weight1_a, weight2_a : signed(11 downto 0);
...
begin
    ...
    generic map (
        ...
        nb_examples_max => nb_examples_max )
    port map (
        clk => clk, AXIS_in => AXIS_in, AXIS_out => AXIS_out,
