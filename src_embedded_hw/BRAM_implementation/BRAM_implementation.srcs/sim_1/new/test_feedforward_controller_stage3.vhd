...
entity test_feedforward_controller_stage3 is
--  Port ( );
end test_feedforward_controller_stage3;

architecture Behavioral of test_feedforward_controller_stage3 is
    ...
    port (
        ...
        stage3_done:            out std_logic );
    end component;
    
    constant nb_features: natural := 3;
    constant nb_hidden_nodes: natural := 3;
    constant nb_output_nodes: natural := 2;
    constant nb_examples_max: natural := 200;
    constant single_ended: std_logic := '0';
    constant nb_examples : natural range 0 to (nb_examples_max-1) := 1;
    
    type features_t is array (0 to (nb_features*nb_examples - 1)) of integer;
    signal features_RAM : features_t := (400,500,1000);
    ...
    signal weights2_RAM: weights2_t := (10,20,11,22,12,24,13,26);
    ...
    signal clk, feedforward_en, feedforward_new, stage3_done: std_logic;
