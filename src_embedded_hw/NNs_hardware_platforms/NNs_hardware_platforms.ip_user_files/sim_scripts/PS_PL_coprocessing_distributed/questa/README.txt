...
#
# Generated by export_simulation on Sat Nov 12 23:39:14 MYT 2016
#
################################################################################
...
./PS_PL_coprocessing_distributed.sh
...
switch to the './PS_PL_coprocessing_distributed.sh' script.

./PS_PL_coprocessing_distributed.sh -reset_run
...
./PS_PL_coprocessing_distributed.sh -noclean_files

For more information on the script, please type './PS_PL_coprocessing_distributed.sh -help'.
