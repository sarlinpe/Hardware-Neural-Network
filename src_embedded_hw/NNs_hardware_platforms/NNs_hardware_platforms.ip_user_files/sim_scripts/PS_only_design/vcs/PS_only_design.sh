...
#
# Generated by Vivado on Sun Oct 16 14:55:08 MYT 2016
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: PS_only_design.sh [-help]
# usage: PS_only_design.sh [-lib_map_path]
# usage: PS_only_design.sh [-noclean_files]
# usage: PS_only_design.sh [-reset_run]
#
...
# executing this script. Please type 'PS_only_design.sh -help' for more information.
#
...
# Design libraries
design_libs=(xil_defaultlib xpm processing_system7_bfm_v2_0_5 axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_11 blk_mem_gen_v8_3_3 axi_bram_ctrl_v4_0_8 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_9 fifo_generator_v13_1_1 axi_data_fifo_v2_1_8 axi_crossbar_v2_1_10 axi_protocol_converter_v2_1_9)

# Simulation root library directory
sim_lib_dir="vcs"

# Script info
echo -e "PS_only_design.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_processing_system7_0_0/sim/PS_only_design_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_axi_gpio_0_0/sim/PS_only_design_axi_gpio_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_axi_bram_ctrl_0_0/sim/PS_only_design_axi_bram_ctrl_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_rst_processing_system7_0_100M_0/sim/PS_only_design_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_xbar_0/sim/PS_only_design_xbar_0.v" \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_axi_bram_ctrl_0_bram_0/sim/PS_only_design_axi_bram_ctrl_0_bram_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_auto_pc_0/sim/PS_only_design_auto_pc_0.v" \
    "$ref_dir/../../../bd/PS_only_design/ip/PS_only_design_auto_pc_1/sim/PS_only_design_auto_pc_1.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_only_design/hdl/PS_only_design.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PS_only_design xil_defaultlib.glbl -o PS_only_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PS_only_design_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./PS_only_design.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key PS_only_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc PS_only_design_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./PS_only_design.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: PS_only_design.sh [-help]\n\
Usage: PS_only_design.sh [-lib_map_path]\n\
Usage: PS_only_design.sh [-reset_run]\n\
Usage: PS_only_design.sh [-noclean_files]\n\n\
