...
#
# Filename    : PS_PL_coprocessing.sh
...
#
# Generated by Vivado on Sat Nov 12 23:48:38 MYT 2016
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: PS_PL_coprocessing.sh [-help]
# usage: PS_PL_coprocessing.sh [-lib_map_path]
# usage: PS_PL_coprocessing.sh [-noclean_files]
# usage: PS_PL_coprocessing.sh [-reset_run]
#
...
# executing this script. Please type 'PS_PL_coprocessing.sh -help' for more information.
#
...
# Script info
echo -e "PS_PL_coprocessing.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_processing_system7_0_1/sim/PS_PL_coprocessing_processing_system7_0_1.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_axi_dma_0_0/sim/PS_PL_coprocessing_axi_dma_0_0.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/utility.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/imports/Hardware_designs/sigmoid.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/feedforward_dataflow.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/feedforward_controller.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/AXIS_controller.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/main_controller.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/imports/project_module_workspace/AXIS_interface.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/imports/project_module_workspace/lfsr_counter.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/weights_generator.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/new/prediction.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/imports/bp_GOOD/back_prop_controller.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ipshared/user.org/axis_mlp_neural_network_v1_0/project_module_workspace.srcs/sources_1/imports/bp_GOOD/back_prop_dataflow.vhd" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_AXIS_MLP_Neural_Network_0_0/sim/PS_PL_coprocessing_AXIS_MLP_Neural_Network_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_rst_processing_system7_0_100M_0/sim/PS_PL_coprocessing_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_xbar_0/sim/PS_PL_coprocessing_xbar_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/PS_PL_coprocessing/hdl/PS_PL_coprocessing.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_auto_pc_0/sim/PS_PL_coprocessing_auto_pc_0.v" \
    "$ref_dir/../../../bd/PS_PL_coprocessing/ip/PS_PL_coprocessing_auto_pc_1/sim/PS_PL_coprocessing_auto_pc_1.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PS_PL_coprocessing xil_defaultlib.glbl -o PS_PL_coprocessing_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PS_PL_coprocessing_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./PS_PL_coprocessing.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key PS_PL_coprocessing_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc PS_PL_coprocessing_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./PS_PL_coprocessing.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: PS_PL_coprocessing.sh [-help]\n\
Usage: PS_PL_coprocessing.sh [-lib_map_path]\n\
Usage: PS_PL_coprocessing.sh [-reset_run]\n\
Usage: PS_PL_coprocessing.sh [-noclean_files]\n\n\
