...
--    attribute mark_debug of state_curr, axis_command: signal is "true";
    --attribute mark_debug of cnt_examples, output_buffer: signal is "true";
...
begin
    ...
    axis_combi_proc: process (state_curr, axis_command, output_buffer,pred_ram, --results_ram, 
...
--                        end if;
--                        results_read_req <= '1';
--                        results_addr <= cnt_examples_next;
--                    end if;
