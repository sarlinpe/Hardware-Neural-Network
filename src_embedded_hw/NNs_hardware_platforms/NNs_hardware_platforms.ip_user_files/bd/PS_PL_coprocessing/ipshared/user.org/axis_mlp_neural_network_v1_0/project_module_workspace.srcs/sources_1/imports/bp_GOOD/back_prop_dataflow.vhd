...
end back_prop_dataflow;



architecture version1 of back_prop_dataflow is
...
--        end process stage_4;
        ...
        begin
            if rising_edge(CLK) then
                if (backprop_en = '1') then
                next_weight2_write_ram <= weight2_read_ram - shift_right(BIG_DELTA2_read_ram(31 downto 20),5);
                next_weight1_write_ram <= weight1_read_ram - shift_right(BIG_DELTA1_read_ram(31 downto 20),5);
